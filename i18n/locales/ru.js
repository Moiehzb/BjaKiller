...
const ru = {
  ...
  badgeModal: {
    ...
    body: 'Эта печать отмечает редких счётчиков, покоривших Бурю. Ты получил её, пройдя Высшее испытание — она отличает тебя от простых игроков.',
    latestLabel: 'Получено за',
    cta: 'Мои достижения',
  },
