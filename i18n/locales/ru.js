...
const ru = {
  ...
  achievementsModal: {
    ...
    reward: 'Награда',
    secretReward: 'Артефакт «Obsidian Void»',
  },

  badgeModal: {
    seal: 'Печать Гильдии',
    title: 'Признанный счётчик',
    body: ({ count }) => `Эта печать свидетельствует о твоём положении в Гильдии. Достижений закреплено за тобой: ${count}. Носи её — она отличает тебя от простых игроков.`,
    latestLabel: 'Последнее достижение',
    cta: 'Мои достижения',
  },
  ...
  challenges: {
    ...
    flash: { name: 'Fulgur', desc: '2 колоды · 50% пен. · 0,45с/карта или меньше · счётчик закрыт — вне Бури' },
    advanced_test: { name: 'Высшее испытание', desc: 'Буря · 2 колоды · 50% пен. · менее 25с — счётчик закрыт' },
  ...
  academySwitcher: {
    ...
    desc1: 'Тренировка счёта Hi-Lo по одной карте: ранги, рейтинг, ежедневный ритуал и Испытание — академия, которую ты проходишь прямо сейчас.',
    next: 'Следующий этап',
    title2: 'HI-LO ACADEMY II',
    desc2: 'Живой стол: несколько симулированных столов казино одновременно, крупье и игроки — оттачивай счёт в реальных условиях.',
    cta2: 'Доступно в Google Play Store.',
  },
};
