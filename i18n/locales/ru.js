...
const ru = {
  ...
  lobby: {
    ...
    rankedSub: ({ rank, desc, abandon }) => `${rank} · ${desc} · Выход = ${abandon} ОМР`,
    ...
    dailyCatchupSub: ({ decks: d, secs }) => `${d} ${decks(d)} · ~${secs}с · Вчерашний ритуал пропущен — наверстайте его (сегодня 2 ритуала, чтобы сохранить серию)`,
    dailyCatchupSecondSub: ({ decks: d, secs }) => `${d} ${decks(d)} · ~${secs}с · Второй ритуал дня ещё предстоит выполнить`,
    dailyDoneWin: ({ score }) => `✓ Выполнено · ${score} оч.`,
    dailyDoneLoss: '✗ Не выполнено',
    dailyRecovered: '✓ Серия восстановлена',
  ...
  rankedConfig: {
    ...
    rankedSub: ({ rank, win, loss }) =>
      `${rank} · +${win} ОМР · ${loss} ОМР · Выход ${loss} ОМР`,
    ...
    abandonWarn: ({ abandon }) => `Выход из игры = ${abandon} ОМР`,
  },
  ...
  game: {
    ...
    dailyStreakRecovered: ({ n }) => `Серия ${n} дн., восстановлена.`,
    dailyCatchupPending: 'Сегодняшний ритуал ещё предстоит выполнить.',
