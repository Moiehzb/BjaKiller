...
const fr = {
  ...
  lobby: {
    ...
    dailyCatchupSub: ({ decks, secs }) => `${decks} deck${decks > 1 ? 's' : ''} · ~${secs}s · Rituel d'hier manqué — rattrape-le (2 rituels aujourd'hui pour garder ta série)`,
    dailyCatchupSecondSub: ({ decks, secs }) => `${decks} deck${decks > 1 ? 's' : ''} · ~${secs}s · Second rituel du jour à accomplir`,
    dailyDoneWin: ({ score }) => `✓ Accompli · ${score} pts`,
    dailyDoneLoss: '✗ Manqué',
    dailyRecovered: '✓ Série reconstituée',
  ...
  game: {
    ...
    dailyStreakRecovered: ({ n }) => `Série de ${n} jour${n > 1 ? 's' : ''} reconstituée.`,
    dailyCatchupPending: 'Il te reste le rituel d\'aujourd\'hui à accomplir.',
