...
const fr = {
  ...
  lobby: {
    ...
    dailyCatchupSub: ({ decks, secs, left }) => `${decks} deck${decks > 1 ? 's' : ''} · ~${secs}s · Rattrapage : ${left} tentative${left > 1 ? 's' : ''} pour sauver ta série`,
  ...
  game: {
    ...
    dailyCatchupRetry: 'Série menacée — une tentative de rattrapage reste possible aujourd\'hui.',
